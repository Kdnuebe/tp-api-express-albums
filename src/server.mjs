...
import Albums from './controllers/albums.mjs';  // Ajout de l'importation pour Albums
import Photos from './controllers/photos.mjs';  // Ajout de l'importation pour Photos
...
const Server = class Server {
  ...
  routes() {
    // Ajout des routes pour Albums et Photos
